...
float* homomat(coordinate x1, coordinate x2, coordinate x3, coordinate x4,
    coordinate y1, coordinate y2, coordinate y3, coordinate y4);
int* mmult(float* a, int x, int y);
...
float* homomat(coordinate c1, coordinate c2, coordinate c3, coordinate c4,
...
int* mmult(float* a, int x, int y) {
    ...
    c[0] = (a[0] * x + a[1] * y + a[2]) / (a[6] * x + a[7] * y + a[8]);
    c[1] = (a[3] * x + a[4] * y + a[5]) / (a[6] * x + a[7] * y + a[8]);
    //if (a[6] * x + a[7] * y + a[8] != 1) printf("???? %f\n", a[6] * x + a[7] * y + a[8]);
