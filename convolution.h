...
typedef unsigned char TYPE;// 여기서 data type을 설정하세요.
typedef int filter_TYPE;


void conv(TYPE* output_data, TYPE* input_data, float* filter, int row_size, int col_size, int filter_row_size);
